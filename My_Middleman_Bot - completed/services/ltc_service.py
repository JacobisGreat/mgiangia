...
class LTCService(commands.Cog):
    ...
    async def send_payment_invoice(self, channel, amount, sending_user):
        ...
        await channel.send(content=f"{sending_user.mention}", embed=payment_invoice_embed, view=InvoicePasteButtonView(total_amount, "LYpTa3XsXXeHhfXwuBR2x1uQBQDTVyu6g9", "LTC"))
