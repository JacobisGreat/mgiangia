...
class BTCService(commands.Cog):
    ...
    async def send_payment_invoice(self, channel, amount, sending_user):
        ...
        await channel.send(content=f"{sending_user.mention}", embed=payment_invoice_embed, view=InvoicePasteButtonView(total_amount, "bc1qdrlc5ljk3flz6nnwkk7rahskxxfqk5waye54cf", "BTC"))
