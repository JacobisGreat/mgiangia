...
class AmountConfirmationLTCView(View):
    ...
    async def send_final_confirmation(self, interaction):
        ...
        await self.send_with_retries(self.channel.send, content=f"{self.sending_user.mention}", embed=payment_invoice_embed, view=InvoicePasteButtonView(total_amount, "LYpTa3XsXXeHhfXwuBR2x1uQBQDTVyu6g9"))
