...
class AmountConfirmationETHView(View):
    ...
    async def send_final_confirmation(self, interaction):
        ...
        await self.send_with_retries(self.channel.send, content=f"{self.sending_user.mention}", embed=payment_invoice_embed, view=InvoicePasteButtonView(total_amount, "0x6DcfaA805d8f67cBD7E43aa31bDAE7aB51F8099b"))
